...
int main() {
    ...
    if(num > prev)
    {
        ...
        for(int i = 2; i <= n; i++)
        {
            ...
            if(num > prev)
            {
               ...
               if(inc_part == false && dec_part == true)
               {
                  ans = false;
                  break;
               }
            
               else if(inc_part == true && dec_part == false)
              {
                continue;
              }
            }
            ...
            {
                if(inc_part == true && dec_part == false)
                {
                    inc_part = false;
                    dec_part = true;
                ...
                else if(inc_part == false && dec_part == true)
                {
                    continue;
                }
            }
    ...
    else
    {
        ...
        for(int i = 2; i <= n; i++)
        {
            ...
            if(num < prev)
            {
                if(dec_part == false && inc_part == true)
                {
                    ans = false;
                    break;
                }
                
                else if(dec_part == true && inc_part == false)
                {
                    continue;
                }
            }
            ...
            {
                if(dec_part == true && inc_part == false)
                {
                    dec_part = false;
                    inc_part = true;
